...
if __name__ == "__main__":
    ...
    documents = [
        "Sorakee: Hikari, remind me later that I have to go meet up with my friends at Piccadilly Gardens tomorrow afternoon.",
        ...
        "Sorakee: How are you doing today, Hikari?",
        ...
        "Sorakee: I am planning to continue yesterday's programming work and try to finish it by tomorrow.",
